...
data class StartupDispatchers(
    ...
    companion object {
         ...
         * 这是最常用和最均衡的配置。
         */
        fun createDefault(): StartupDispatchers = StartupDispatchers(
         ...
         *   仅适用于所有任务都非常轻量级的场景。
         */
        fun createAllMain(): StartupDispatchers = StartupDispatchers(
         ...
         */
        fun createAllIO(): StartupDispatchers = StartupDispatchers(
            startDispatcher = Dispatchers.IO,
         ...
         * - 回调在Main线程执行，确保UI更新。
         * - **注意**: 与 `createAllIO` 方案类似，`Initializer` 内部不能直接操作UI。
         */
        fun createExecuteOnIO(): StartupDispatchers = StartupDispatchers(
            startDispatcher = Dispatchers.IO,
            executeDispatcher = Dispatchers.IO,
            callbackDispatcher = Dispatchers.Main
        )
